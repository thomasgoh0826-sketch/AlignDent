...
AlignDent `v0.1.3` 的 Windows 安装包使用 Zyls 自签名代码证书进行 Authenticode 签名，并使用公开时间戳服务记录签署时间。
...
```powershell
$file = '.\AlignDent-Setup-0.1.3-x64.exe'
...
`0999DD1578DB68BD58F859D36F72E037F7DB1F1297FAAAC4994FC9DCCDB4A1E9`
